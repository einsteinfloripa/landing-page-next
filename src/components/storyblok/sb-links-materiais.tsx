...
export const SbLinksMateriaisSection = ({
  blok,
}: Blok<StoryblokLinksMateriaisSection>) => {
  ...
  return (
    ...
    >
      <PaperTextureBackground
        className="bg-app-neutral-10 rotate-180"
        opacity={50}
        version={2}
      />
      <Image
      ...
      <div className="relative w-full flex flex-col sm:px-24 py-24 sm:py-36 px-4">
        <div className="flex flex-col text-center w-full gap-1 items-center justify-center xl:mb-10 z-10 px-5 sm:px-auto">
          ...
          <RichText
            richText={descricao}
            className={{ paragraph: "text-app-blue-900 text-lg" }}
          />
        </div>
